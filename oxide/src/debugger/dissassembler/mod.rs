...
pub fn disassemble(bytes: &[u8]) -> String {
    match bytes.get(0).unwrap_or(&0) {
        ...
        0xC0 => format!("RET NZ"),
        0xC1 => format!("POP BC"),
        0xC2 => format!("JP NZ, a16"),
        0xC3 => format!("JP a16"),
        0xC4 => format!("CALL NZ, a16"),
        0xC5 => format!("PUSH BC"),
        0xC6 => format!("ADD A, {:#04X}", bytes.get(1).copied().unwrap_or(0)),
        0xC7 => format!("RST 00H"),
        0xC8 => format!("RET Z"),
        0xC9 => format!("RET"),
        0xCA => format!("JP Z, a16"),
        0xCC => format!("CALL Z, a16"),
        0xCD => format!("CALL a16"),
        0xCE => format!("ADC A, {:#04X}", bytes.get(1).copied().unwrap_or(0)),
        0xCF => format!("RST 08H"),
        0xD0 => format!("RET NC"),
        0xD1 => format!("POP DE"),
        0xD2 => format!("JP NC, a16"),
        0xD4 => format!("CALL NC, a16"),
        0xD5 => format!("PUSH DE"),
        0xD6 => format!("SUB {:#04X}", bytes.get(1).copied().unwrap_or(0)),
        0xD7 => format!("RST 10H"),
        0xD8 => format!("RET C"),
        0xD9 => format!("RETI"),
        0xDA => format!("JP C, a16"),
        0xDC => format!("CALL C, a16"),
